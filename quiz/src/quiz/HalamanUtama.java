...
public class HalamanUtama extends JFrame {
    ...
    public HalamanUtama(String username) {
        ...
        inputPanel.setBorder(BorderFactory.createTitledBorder("Input Data Karyawan"));
        
        firstNameLabel.setBounds(20, 30, 100, 25);
        firstNameField.setBounds(130, 30, 200, 25);
        
        lastNameLabel.setBounds(20, 65, 100, 25);
        lastNameField.setBounds(130, 65, 200, 25);
        ...
        listPanel.setBorder(BorderFactory.createTitledBorder("Data Karyawan"));
